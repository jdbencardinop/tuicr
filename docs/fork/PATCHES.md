...
| `prepare-cross-platform-fork-release` | `828cd12` | `0c15cd8` | Tracked feature: `state: applied`; recipe replay, local packaging, Cargo install, and supported library suite pass | Linux x86_64 archive passes locally; native Linux arm64 and macOS x86_64/arm64 candidate workflow pending | Fork-only release identity, distribution, and promotion policy |
